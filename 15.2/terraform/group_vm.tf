...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>It's my picture</title></head> <body><h1>Look at hell!!!</h1><img src="http://${yandex_storage_bucket.ayuulyanov.bucket_domain_name}/welcome-to-hell.jpg"/></body></html>' > index.html
EOF
    }
  }
